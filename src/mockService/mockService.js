...
export function getSingleProductFromDataBase(idParams) {
    return new Promise((resolve, reject) => {
        setTimeout(() => {
            let productRequested = productsDataBase.find(
...
export function getProductsFromDataBaseByStyle(styleid) {
    return new Promise((resolve) => {
        setTimeout(() => {
            let productsRequested = productsDataBase.filter(
                (product) => product.estilo === styleid)
